...
export class CheckoutService{
    ...
    //Compra un solo productso
    async singleProductCheckout(productId,requiredQuantity,userId){
        try{
            //revisa que haya stock, si hay sigue, si no , sale...
            //si compra entonces actualiza stock
            //genera un ticket
        }catch{
            throw new Error('Error al intentar single checkout desde checkout Service...')
        }
    }
}